...
<body <?php body_class(); ?>>
	...
	<div class="responsive-nav-button-container" data-responsive-toggle="top-level-navigation" data-hide-for="medium">
				...
				<div class="small-12 cell">
					<div class="top-bar">
						<div class="top-bar-title">
							<h1 class="site-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/indienomicon-logo.svg" alt="Indienomicon Logo">Indienomicon</a></h1>
						</div>
